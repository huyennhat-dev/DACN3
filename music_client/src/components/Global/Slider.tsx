...
const Slider: React.FC<sliderProps> = ({ setWidth, setHeight, percentSlider, getPercentSlider, toggleTooltip, currentTimeSongTooltip }) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          */}
          <div
            className="top-0 left-[0%] absolute z-[1] bg-primary00 rounded-[15px]"
            style={{
              width: `${percentSlider}%`,
              height: `${setHeight}`
            }}
          ...
          */}
          <div
            className="absolute z-[5] w-2 h-2 top-[50%] translate-x-[-50%] translate-y-[-50%] transition-[left]"
            style={{
              left: `${percentSlider}%`
            }}
          >
            {/* Dot Handle */}
            <div
              className={"cursor-pointer w-full h-full rounded-full bg-[#000] box-border " +
